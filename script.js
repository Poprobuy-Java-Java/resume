 ...
 education: [
  {
    ...
    degree: "Магистратура",
    place: "ФГАОУ ВО «РГГУ",
    program: "Информационная безопасность / Организация и технологии защиты государственной тайны"
  },
  {
    period: "2019 — 2023",
    degree: "Бакалавриат",
...
projects: [
  {
    ...
    description: "Разработал кейс для отборочного этапа Хакатона, в котором участникам предстояло расследовать инцидент ИБ. Цепочка цифровых следов, подозрительные события и только один виновный. Один?",
    link: "pages/crimesql.html"

  },
  {
    type: "Дизайн",
    title: "Знакомьтесь — Эля!",
    description: "Выявил потребность, создал концепт, подобрал цвета, архетип и вручную отрисовал визуального аватара для обучающих курсов. Почему Эля? NDA!",
    link: "pages/mascot.html"

  },
  {
    type: "Экзамен",
    title: "Подземелья и команды",
    description: "Спроектировал и реализовал изолированное пятиэтажное Bash-подземелье для закрепления темы Linux на промежуточном экзамене учебного центра.",
...
experience: [
    ...
    role: "Старший специалист группы внешнего обучения и сертификации",
        responsibilities: [
      "Проектирование и разработка образовательных программ, курсов и учебных материалов.",
      "Организация обучения студентов, стажеров и партнеров компании.",
      "Администрирование и развитие LMS-платформы.",
      "Проведение лекций, мастер-классов, тренингов и хакатонов.",
      "Онбординг новых сотрудников.",
      "Координация работы учебных центров",
      "Обратная связь и консультации со студентами учебного центра",
      "Подготовка документации для аккредитации IT-компании."
    ],
    achievements: [
      "Спроектировал и внедрил ролевую модель на LMS-платформе, переработал интерфейс и верстку курсов, что привело к росту активной внутренней аудутории и возможности продажи курсов на внешний рынок.",
      "Спроектировал и реализовал образовательную программу полного цикла для научно-исследовательского центра на базе института: базовый модуль по ключевым IT-навыкам и трех специализированных траекторий подготовки - QA, Аудит ИБ, Инженер внедрения. Увеличил набор в учебный центр и повысил качество знаний выпущенных студентов.",
      "Внедрил CTF продуктового хакатона для MVP-решений компании: повышение вовлечённости студентов учебного центра в 3 раза, выявление нескольких критических дефектов продукта, увеличение тестового покрытия.",
      "Увеличил количество образовательных партнеров компании в рамках подготовки к аккредитации в 3 раза."
    ]
  },
  {
    ...
    responsibilities: [
      ...
      "Участие в статическом тестировании продуктов.",
      "Подготовка документация и отчетов по итогам тестирования.",
      "Участие в разработке Моделей угроз."
    ],
    achievements: [
      "Изучил методику анализа уязвимостей и НДВ.",
      "Получил практический опыт подготовки сертификационной документации.",
      "Работал с нормативной базой и процессами сертификации со стороны лаборатории."
    ]
  }
],
  ...
  publications: [
    ...
    {
      source: "Habr",
      title: "Хакатоны только для гениев?",
      link: "https://habr.com/ru/companies/ctsg/articles/893028/"
    },
    {
      source: "МИРЭА",
